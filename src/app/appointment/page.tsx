...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://lavendrabeautylounge.com/appointment",
  },
  openGraph: {
    title: "Book a Resplendent Appointment | Lavendra Beauty Lounge",
    ...
    url: "https://lavendrabeautylounge.com/appointment",
    siteName: "Lavendra Beauty Lounge",
    images: [
      {
        url: "https://lavendrabeautylounge.com/images/appointment_hero.webp",
        width: 800,
        height: 600,
  ...
  twitter: {
    ...
    images: ["https://lavendrabeautylounge.com/images/appointment_hero.webp"],
  },
};
