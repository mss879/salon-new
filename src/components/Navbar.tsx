...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`w-full flex justify-center py-4 md:py-6 px-4 md:px-6 z-50 transition-all duration-300 ${
        isOpen
          ? "fixed top-0 left-0 bg-transparent border-b border-transparent"
          : "sticky top-0 bg-background/90 backdrop-blur-md border-b border-black/5"
      }`}>
          ...
          >
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4 mt-2">
                ...
                <Link 
                  href="https://www.tiktok.com/@lavendra.beauty.lounge?_r=1&_t=ZS-96roySHN5Xe" 
                  target="_blank" 
                  className="w-9 h-9 rounded-full border border-foreground/10 flex items-center justify-center text-foreground/60 hover:text-primary hover:border-primary/30 hover:bg-primary/5 transition-all duration-300"
                >
