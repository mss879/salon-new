      ...
      {!isExiting && (
        ...
        >
          ...
          <div className="flex flex-col items-center gap-8 sm:gap-10 z-10">
            {/* Premium Scissors Motion Animation */}
            <motion.div
              initial={{ scale: 0.7, opacity: 0, y: 20 }}
              animate={{ scale: 1, opacity: 1, y: 0 }}
              transition={{ duration: 1, ease: "easeOut" }}
              className="relative w-32 h-32 flex items-center justify-center mb-4 text-primary"
            >
              ...
              <svg viewBox="0 0 100 100" className="w-24 h-24 sm:w-28 sm:h-28 drop-shadow-[0_6px_15px_rgba(155,48,48,0.18)]">
