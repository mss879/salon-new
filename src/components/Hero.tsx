...
export default function Hero({ startAnimation = true }: { startAnimation?: boolean }) {
  return (
    <section className="w-full relative flex justify-center pt-24 pb-40 sm:pb-44 lg:pb-48 px-6 overflow-hidden">
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center relative z-10">
        
        {/* Left Content */}
        <div className="flex flex-col w-full max-w-2xl lg:max-w-[45rem]">
          <h1 className="font-serif font-bold text-5xl sm:text-6xl lg:text-[4.5rem] leading-[1.05] tracking-tight text-primary mb-6">
            <span className="whitespace-nowrap">Discover your beauty</span><br />
            <span className="whitespace-nowrap">potential with us.</span>
          </h1>
